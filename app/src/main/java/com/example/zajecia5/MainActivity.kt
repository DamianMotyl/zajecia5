...
class MainActivity : AppCompatActivity() {
    private var mlayaut:DrawerLayout? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mlayaut = findViewById<View>(R.id.main_activity) as DrawerLayout
        mtoggle = ActionBarDrawerToggle(this, mlayaut,R.string.open, R.string.close)
